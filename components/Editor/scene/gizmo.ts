...
import { InspectorNotifier } from "../inspector/notifier";
...
export class SceneGizmo {
  ...
  public constructor(editor: Editor) {
      ...
      // Register events
      this._editor.removedNodeObservable.add((n: any) => {
  ...
  public set gizmoType(type: GizmoType) {
      ...
      if (this._currentGizmo) {
          ...
          const node = this._editor.entity?.lastSelectedObject;
  ...
  private _notifyGizmoEndDrag(propertyPath: string): void {
      ...
      const attachedMesh: any = this._currentGizmo?.attachedMesh;
